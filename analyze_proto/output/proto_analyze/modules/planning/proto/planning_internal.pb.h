...
class PlanningData :
 ...
 public:
  ...
  bool has_pull_over_status() const;
  private:
  bool _internal_has_pull_over_status() const;
  public:
  void clear_pull_over_status();
  const ::apollo::planning::PullOverStatus& pull_over_status() const;
  ::apollo::planning::PullOverStatus* release_pull_over_status();
  ::apollo::planning::PullOverStatus* mutable_pull_over_status();
  void set_allocated_pull_over_status(::apollo::planning::PullOverStatus* pull_over_status);
  private:
  const ::apollo::planning::PullOverStatus& _internal_pull_over_status() const;
  ::apollo::planning::PullOverStatus* _internal_mutable_pull_over_status();
  public:
 ...
 private:
  ...
  ::apollo::planning::PullOverStatus* pull_over_status_;
...
// optional .apollo.planning.PullOverStatus pull_over_status = 29;
inline bool PlanningData::_internal_has_pull_over_status() const {
  bool value = (_has_bits_[0] & 0x00002000u) != 0;
  PROTOBUF_ASSUME(!value || pull_over_status_ != nullptr);
  return value;
}
inline bool PlanningData::has_pull_over_status() const {
  return _internal_has_pull_over_status();
}
inline const ::apollo::planning::PullOverStatus& PlanningData::_internal_pull_over_status() const {
  const ::apollo::planning::PullOverStatus* p = pull_over_status_;
...
inline const ::apollo::planning::PullOverStatus& PlanningData::pull_over_status() const {
  // @@protoc_insertion_point(field_get:apollo.planning_internal.PlanningData.pull_over_status)
  return _internal_pull_over_status();
}
inline ::apollo::planning::PullOverStatus* PlanningData::release_pull_over_status() {
  // @@protoc_insertion_point(field_release:apollo.planning_internal.PlanningData.pull_over_status)
  _has_bits_[0] &= ~0x00002000u;
  ::apollo::planning::PullOverStatus* temp = pull_over_status_;
  pull_over_status_ = nullptr;
  return temp;
}
inline ::apollo::planning::PullOverStatus* PlanningData::_internal_mutable_pull_over_status() {
  _has_bits_[0] |= 0x00002000u;
  if (pull_over_status_ == nullptr) {
    auto* p = CreateMaybeMessage<::apollo::planning::PullOverStatus>(GetArenaNoVirtual());
    pull_over_status_ = p;
  }
  return pull_over_status_;
}
inline ::apollo::planning::PullOverStatus* PlanningData::mutable_pull_over_status() {
  // @@protoc_insertion_point(field_mutable:apollo.planning_internal.PlanningData.pull_over_status)
  return _internal_mutable_pull_over_status();
}
inline void PlanningData::set_allocated_pull_over_status(::apollo::planning::PullOverStatus* pull_over_status) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(pull_over_status_);
  }
  if (pull_over_status) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena = nullptr;
    if (message_arena != submessage_arena) {
      pull_over_status = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, pull_over_status, submessage_arena);
    }
    _has_bits_[0] |= 0x00002000u;
  } else {
    _has_bits_[0] &= ~0x00002000u;
  ...
  // @@protoc_insertion_point(field_set_allocated:apollo.planning_internal.PlanningData.pull_over_status)
}
