...
class FemPosDeviationSmootherConfig :
 ...
 public:
  ...
  enum : int {
    ...
    kMaxIterFieldNumber = 10,
    kScaledTerminationFieldNumber = 13,
    kWarmStartFieldNumber = 14,
    kMaxNumOfIterationsFieldNumber = 21,
    kAcceptableNumOfIterationsFieldNumber = 22,
    kTolFieldNumber = 23,
    kAcceptableTolFieldNumber = 24,
  };
