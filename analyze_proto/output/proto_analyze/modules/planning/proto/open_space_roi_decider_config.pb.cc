...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_modules_2fplanning_2fproto_2fopen_5fspace_5froi_5fdecider_5fconfig_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::apollo::planning::OpenSpaceRoiDeciderConfig, curb_heading_tangent_change_uppper_limit_),
  0,
  4,
  5,
  1,
...
const char descriptor_table_protodef_modules_2fplanning_2fproto_2fopen_5fspace_5froi_5fdecider_5fconfig_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "decider_config.proto\022\017apollo.planning\"\271\004"
  ...
  "rb_heading_tangent_change_uppper_limit\030\013"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fplanning_2fproto_2fopen_5fspace_5froi_5fdecider_5fconfig_2eproto = {
  &descriptor_table_modules_2fplanning_2fproto_2fopen_5fspace_5froi_5fdecider_5fconfig_2eproto_initialized, descriptor_table_protodef_modules_2fplanning_2fproto_2fopen_5fspace_5froi_5fdecider_5fconfig_2eproto, "modules/planning/proto/open_space_roi_decider_config.proto", 649,
...
class OpenSpaceRoiDeciderConfig::_Internal {
 public:
  ...
  static void set_has_curb_heading_tangent_change_uppper_limit(HasBits* has_bits) {
    (*has_bits)[0] |= 1024u;
  }
};
...
OpenSpaceRoiDeciderConfig::OpenSpaceRoiDeciderConfig(const OpenSpaceRoiDeciderConfig& from)
  ...
  ::memcpy(&roi_type_, &from.roi_type_,
    static_cast<size_t>(reinterpret_cast<char*>(&curb_heading_tangent_change_uppper_limit_) -
    reinterpret_cast<char*>(&roi_type_)) + sizeof(curb_heading_tangent_change_uppper_limit_));
    ...
    switch (tag >> 3) {
      ...
      case 11:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 89)) {
          _Internal::set_has_curb_heading_tangent_change_uppper_limit(&has_bits);
          curb_heading_tangent_change_uppper_limit_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<double>(ptr);
          ptr += sizeof(double);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* OpenSpaceRoiDeciderConfig::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000400u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteDoubleToArray(11, this->_internal_curb_heading_tangent_change_uppper_limit(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:apollo.planning.OpenSpaceRoiDeciderConfig)
  ...
  if (cached_has_bits & 0x00000700u) {
    ...
    if (cached_has_bits & 0x00000400u) {
      curb_heading_tangent_change_uppper_limit_ = from.curb_heading_tangent_change_uppper_limit_;
    }
    _has_bits_[0] |= cached_has_bits;
  }
}
...
void OpenSpaceRoiDeciderConfig::InternalSwap(OpenSpaceRoiDeciderConfig* other) {
  ...
  swap(curb_heading_tangent_change_uppper_limit_, other->curb_heading_tangent_change_uppper_limit_);
}
