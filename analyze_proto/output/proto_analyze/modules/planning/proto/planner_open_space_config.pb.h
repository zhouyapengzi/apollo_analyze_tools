...
inline const ::apollo::planning::PiecewiseJerkSpeedConfig& IterativeAnchoringConfig::_internal_s_curve_config() const {
  const ::apollo::planning::PiecewiseJerkSpeedConfig* p = s_curve_config_;
  return p != nullptr ? *p : *reinterpret_cast<const ::apollo::planning::PiecewiseJerkSpeedConfig*>(
      &::apollo::planning::_PiecewiseJerkSpeedConfig_default_instance_);
}
inline const ::apollo::planning::PiecewiseJerkSpeedConfig& IterativeAnchoringConfig::s_curve_config() const {
  // @@protoc_insertion_point(field_get:apollo.planning.IterativeAnchoringConfig.s_curve_config)
  return _internal_s_curve_config();
}
inline ::apollo::planning::PiecewiseJerkSpeedConfig* IterativeAnchoringConfig::release_s_curve_config() {
...
inline ::apollo::planning::PiecewiseJerkSpeedConfig* IterativeAnchoringConfig::_internal_mutable_s_curve_config() {
  _has_bits_[0] |= 0x00000002u;
  if (s_curve_config_ == nullptr) {
    auto* p = CreateMaybeMessage<::apollo::planning::PiecewiseJerkSpeedConfig>(GetArenaNoVirtual());
    s_curve_config_ = p;
...
inline ::apollo::planning::PiecewiseJerkSpeedConfig* IterativeAnchoringConfig::mutable_s_curve_config() {
  // @@protoc_insertion_point(field_mutable:apollo.planning.IterativeAnchoringConfig.s_curve_config)
  return _internal_mutable_s_curve_config();
}
inline void IterativeAnchoringConfig::set_allocated_s_curve_config(::apollo::planning::PiecewiseJerkSpeedConfig* s_curve_config) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(s_curve_config_);
  }
