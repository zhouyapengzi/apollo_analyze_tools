...
class PiecewiseJerkSpeedConfig :
 ...
 public:
  ...
  enum : int {
    ...
    kDkappaPenaltyWeightFieldNumber = 3,
...
// optional double dkappa_penalty_weight = 3 [default = 1000];
inline bool PiecewiseJerkSpeedConfig::_internal_has_dkappa_penalty_weight() const {
  bool value = (_has_bits_[0] & 0x00000004u) != 0;
  return value;
}
inline bool PiecewiseJerkSpeedConfig::has_dkappa_penalty_weight() const {
  return _internal_has_dkappa_penalty_weight();
}
inline void PiecewiseJerkSpeedConfig::clear_dkappa_penalty_weight() {
  dkappa_penalty_weight_ = 1000;
  _has_bits_[0] &= ~0x00000004u;
}
inline double PiecewiseJerkSpeedConfig::_internal_dkappa_penalty_weight() const {
  return dkappa_penalty_weight_;
}
inline double PiecewiseJerkSpeedConfig::dkappa_penalty_weight() const {
  // @@protoc_insertion_point(field_get:apollo.planning.PiecewiseJerkSpeedConfig.dkappa_penalty_weight)
  return _internal_dkappa_penalty_weight();
}
inline void PiecewiseJerkSpeedConfig::_internal_set_dkappa_penalty_weight(double value) {
  _has_bits_[0] |= 0x00000004u;
  dkappa_penalty_weight_ = value;
}
inline void PiecewiseJerkSpeedConfig::set_dkappa_penalty_weight(double value) {
  _internal_set_dkappa_penalty_weight(value);
  // @@protoc_insertion_point(field_set:apollo.planning.PiecewiseJerkSpeedConfig.dkappa_penalty_weight)
}
