...
class OpenSpaceRoiDeciderConfig :
 ...
 public:
  ...
  enum : int {
    ...
    kCurbHeadingTangentChangeUppperLimitFieldNumber = 11,
  };
  ...
  // optional double curb_heading_tangent_change_uppper_limit = 11 [default = 1];
  bool has_curb_heading_tangent_change_uppper_limit() const;
  private:
  bool _internal_has_curb_heading_tangent_change_uppper_limit() const;
  public:
  void clear_curb_heading_tangent_change_uppper_limit();
  double curb_heading_tangent_change_uppper_limit() const;
  void set_curb_heading_tangent_change_uppper_limit(double value);
  private:
  double _internal_curb_heading_tangent_change_uppper_limit() const;
  void _internal_set_curb_heading_tangent_change_uppper_limit(double value);
  public:
 ...
 private:
  ...
  double curb_heading_tangent_change_uppper_limit_;
...
// optional double curb_heading_tangent_change_uppper_limit = 11 [default = 1];
inline bool OpenSpaceRoiDeciderConfig::_internal_has_curb_heading_tangent_change_uppper_limit() const {
  bool value = (_has_bits_[0] & 0x00000400u) != 0;
  return value;
}
inline bool OpenSpaceRoiDeciderConfig::has_curb_heading_tangent_change_uppper_limit() const {
  return _internal_has_curb_heading_tangent_change_uppper_limit();
}
inline void OpenSpaceRoiDeciderConfig::clear_curb_heading_tangent_change_uppper_limit() {
  curb_heading_tangent_change_uppper_limit_ = 1;
  _has_bits_[0] &= ~0x00000400u;
}
inline double OpenSpaceRoiDeciderConfig::_internal_curb_heading_tangent_change_uppper_limit() const {
  return curb_heading_tangent_change_uppper_limit_;
}
inline double OpenSpaceRoiDeciderConfig::curb_heading_tangent_change_uppper_limit() const {
  // @@protoc_insertion_point(field_get:apollo.planning.OpenSpaceRoiDeciderConfig.curb_heading_tangent_change_uppper_limit)
  return _internal_curb_heading_tangent_change_uppper_limit();
}
inline void OpenSpaceRoiDeciderConfig::_internal_set_curb_heading_tangent_change_uppper_limit(double value) {
  _has_bits_[0] |= 0x00000400u;
  curb_heading_tangent_change_uppper_limit_ = value;
}
inline void OpenSpaceRoiDeciderConfig::set_curb_heading_tangent_change_uppper_limit(double value) {
  _internal_set_curb_heading_tangent_change_uppper_limit(value);
  // @@protoc_insertion_point(field_set:apollo.planning.OpenSpaceRoiDeciderConfig.curb_heading_tangent_change_uppper_limit)
}
