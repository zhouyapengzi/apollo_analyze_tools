...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fbridge_2fproto_2fudp_5fbridge_5fremote_5finfo_2eproto = {
  &descriptor_table_modules_2fbridge_2fproto_2fudp_5fbridge_5fremote_5finfo_2eproto_initialized, descriptor_table_protodef_modules_2fbridge_2fproto_2fudp_5fbridge_5fremote_5finfo_2eproto, "modules/bridge/proto/udp_bridge_remote_info.proto", 329,
    ...
    switch (tag >> 3) {
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 32)) {
          ...
          enable_timeout_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
