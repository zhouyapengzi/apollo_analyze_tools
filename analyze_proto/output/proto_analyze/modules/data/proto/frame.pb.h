...
class Frame :
 ...
 public:
  ...
  ::Vector3* release_device_position();
  ...
  ::Quaternion* release_device_heading();
  ...
  ::GPSPose* release_device_gps_pose();
...
inline void CameraImage::set_image_url(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:CameraImage.image_url)
}
inline void CameraImage::set_image_url(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:CameraImage.image_url)
}
inline void CameraImage::set_image_url(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:CameraImage.image_url)
}
...
inline void CameraImage::set_channel(std::string&& value) {
  ...
  channel_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:CameraImage.channel)
}
inline void CameraImage::set_channel(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:CameraImage.channel)
}
inline void CameraImage::set_channel(const char* value, size_t size) {
  ...
  channel_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:CameraImage.channel)
}
...
inline ::GPSPose* Frame::_internal_mutable_device_gps_pose() {
  ...
  if (device_gps_pose_ == nullptr) {
    auto* p = CreateMaybeMessage<::GPSPose>(GetArenaNoVirtual());
    device_gps_pose_ = p;
  }
...
inline void Frame::set_data_file(std::string&& value) {
  ...
  data_file_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:Frame.data_file)
}
inline void Frame::set_data_file(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:Frame.data_file)
}
inline void Frame::set_data_file(const char* value, size_t size) {
  ...
  data_file_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:Frame.data_file)
}
