...
class CNNSegConfig :
 ...
 public:
  ...
  enum : int {
    ...
    kPaddleParamFileFieldNumber = 5,
    kPaddleProtoFileFieldNumber = 6,
    kPaddleWeightFileFieldNumber = 7,
    kUsePaddleFieldNumber = 8,
  };
  ...
  bool has_paddle_param_file() const;
  private:
  bool _internal_has_paddle_param_file() const;
  public:
  void clear_paddle_param_file();
  const std::string& paddle_param_file() const;
  void set_paddle_param_file(const std::string& value);
  void set_paddle_param_file(std::string&& value);
  void set_paddle_param_file(const char* value);
  void set_paddle_param_file(const char* value, size_t size);
  std::string* mutable_paddle_param_file();
  std::string* release_paddle_param_file();
  void set_allocated_paddle_param_file(std::string* paddle_param_file);
  private:
  const std::string& _internal_paddle_param_file() const;
  void _internal_set_paddle_param_file(const std::string& value);
  std::string* _internal_mutable_paddle_param_file();
  public:

  // optional string paddle_proto_file = 6 [default = "./data/models/cnnseg/model"];
  bool has_paddle_proto_file() const;
  private:
  bool _internal_has_paddle_proto_file() const;
  public:
  void clear_paddle_proto_file();
  const std::string& paddle_proto_file() const;
  void set_paddle_proto_file(const std::string& value);
  void set_paddle_proto_file(std::string&& value);
  void set_paddle_proto_file(const char* value);
  void set_paddle_proto_file(const char* value, size_t size);
  std::string* mutable_paddle_proto_file();
  std::string* release_paddle_proto_file();
  void set_allocated_paddle_proto_file(std::string* paddle_proto_file);
  private:
  const std::string& _internal_paddle_proto_file() const;
  void _internal_set_paddle_proto_file(const std::string& value);
  std::string* _internal_mutable_paddle_proto_file();
  public:

  // optional string paddle_weight_file = 7 [default = "./data/models/cnnseg/params"];
  bool has_paddle_weight_file() const;
  private:
  bool _internal_has_paddle_weight_file() const;
  public:
  void clear_paddle_weight_file();
  const std::string& paddle_weight_file() const;
  void set_paddle_weight_file(const std::string& value);
  void set_paddle_weight_file(std::string&& value);
  void set_paddle_weight_file(const char* value);
  void set_paddle_weight_file(const char* value, size_t size);
  std::string* mutable_paddle_weight_file();
  std::string* release_paddle_weight_file();
  void set_allocated_paddle_weight_file(std::string* paddle_weight_file);
  private:
  const std::string& _internal_paddle_weight_file() const;
  void _internal_set_paddle_weight_file(const std::string& value);
  std::string* _internal_mutable_paddle_weight_file();
  public:

  // optional bool use_paddle = 8 [default = false];
  bool has_use_paddle() const;
  private:
  bool _internal_has_use_paddle() const;
  public:
  void clear_use_paddle();
  bool use_paddle() const;
  void set_use_paddle(bool value);
  private:
  bool _internal_use_paddle() const;
  void _internal_set_use_paddle(bool value);
  public:
 ...
 private:
  ...
  public:
  static ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<std::string> _i_give_permission_to_break_this_code_default_paddle_param_file_;
  private:
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr paddle_param_file_;
  public:
  static ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<std::string> _i_give_permission_to_break_this_code_default_paddle_proto_file_;
  private:
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr paddle_proto_file_;
  public:
  static ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<std::string> _i_give_permission_to_break_this_code_default_paddle_weight_file_;
  private:
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr paddle_weight_file_;
  bool use_paddle_;
...
// optional string paddle_param_file = 5 [default = "./data/models/cnnseg/paddle_param.conf"];
inline bool CNNSegConfig::_internal_has_paddle_param_file() const {
  bool value = (_has_bits_[0] & 0x00000010u) != 0;
  return value;
}
inline bool CNNSegConfig::has_paddle_param_file() const {
  return _internal_has_paddle_param_file();
}
inline void CNNSegConfig::clear_paddle_param_file() {
  paddle_param_file_.ClearToDefaultNoArena(&::apollo::perception::lidar::CNNSegConfig::_i_give_permission_to_break_this_code_default_paddle_param_file_.get());
  _has_bits_[0] &= ~0x00000010u;
}
inline const std::string& CNNSegConfig::paddle_param_file() const {
  // @@protoc_insertion_point(field_get:apollo.perception.lidar.CNNSegConfig.paddle_param_file)
  return _internal_paddle_param_file();
}
inline void CNNSegConfig::set_paddle_param_file(const std::string& value) {
  _internal_set_paddle_param_file(value);
  // @@protoc_insertion_point(field_set:apollo.perception.lidar.CNNSegConfig.paddle_param_file)
}
inline std::string* CNNSegConfig::mutable_paddle_param_file() {
  // @@protoc_insertion_point(field_mutable:apollo.perception.lidar.CNNSegConfig.paddle_param_file)
  return _internal_mutable_paddle_param_file();
}
inline const std::string& CNNSegConfig::_internal_paddle_param_file() const {
  return paddle_param_file_.GetNoArena();
}
inline void CNNSegConfig::_internal_set_paddle_param_file(const std::string& value) {
  _has_bits_[0] |= 0x00000010u;
  paddle_param_file_.SetNoArena(&::apollo::perception::lidar::CNNSegConfig::_i_give_permission_to_break_this_code_default_paddle_param_file_.get(), value);
}
inline void CNNSegConfig::set_paddle_param_file(std::string&& value) {
  _has_bits_[0] |= 0x00000010u;
  paddle_param_file_.SetNoArena(
    &::apollo::perception::lidar::CNNSegConfig::_i_give_permission_to_break_this_code_default_paddle_param_file_.get(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:apollo.perception.lidar.CNNSegConfig.paddle_param_file)
}
inline void CNNSegConfig::set_paddle_param_file(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000010u;
  paddle_param_file_.SetNoArena(&::apollo::perception::lidar::CNNSegConfig::_i_give_permission_to_break_this_code_default_paddle_param_file_.get(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:apollo.perception.lidar.CNNSegConfig.paddle_param_file)
}
inline void CNNSegConfig::set_paddle_param_file(const char* value, size_t size) {
  _has_bits_[0] |= 0x00000010u;
  paddle_param_file_.SetNoArena(&::apollo::perception::lidar::CNNSegConfig::_i_give_permission_to_break_this_code_default_paddle_param_file_.get(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:apollo.perception.lidar.CNNSegConfig.paddle_param_file)
}
inline std::string* CNNSegConfig::_internal_mutable_paddle_param_file() {
  _has_bits_[0] |= 0x00000010u;
  return paddle_param_file_.MutableNoArena(&::apollo::perception::lidar::CNNSegConfig::_i_give_permission_to_break_this_code_default_paddle_param_file_.get());
}
inline std::string* CNNSegConfig::release_paddle_param_file() {
  // @@protoc_insertion_point(field_release:apollo.perception.lidar.CNNSegConfig.paddle_param_file)
  if (!_internal_has_paddle_param_file()) {
    return nullptr;
  }
  _has_bits_[0] &= ~0x00000010u;
  return paddle_param_file_.ReleaseNonDefaultNoArena(&::apollo::perception::lidar::CNNSegConfig::_i_give_permission_to_break_this_code_default_paddle_param_file_.get());
}
inline void CNNSegConfig::set_allocated_paddle_param_file(std::string* paddle_param_file) {
  if (paddle_param_file != nullptr) {
    _has_bits_[0] |= 0x00000010u;
  } else {
    _has_bits_[0] &= ~0x00000010u;
  }
  paddle_param_file_.SetAllocatedNoArena(&::apollo::perception::lidar::CNNSegConfig::_i_give_permission_to_break_this_code_default_paddle_param_file_.get(), paddle_param_file);
  // @@protoc_insertion_point(field_set_allocated:apollo.perception.lidar.CNNSegConfig.paddle_param_file)
}

// optional string paddle_proto_file = 6 [default = "./data/models/cnnseg/model"];
inline bool CNNSegConfig::_internal_has_paddle_proto_file() const {
  bool value = (_has_bits_[0] & 0x00000020u) != 0;
  return value;
}
inline bool CNNSegConfig::has_paddle_proto_file() const {
  return _internal_has_paddle_proto_file();
}
inline void CNNSegConfig::clear_paddle_proto_file() {
  paddle_proto_file_.ClearToDefaultNoArena(&::apollo::perception::lidar::CNNSegConfig::_i_give_permission_to_break_this_code_default_paddle_proto_file_.get());
  _has_bits_[0] &= ~0x00000020u;
}
inline const std::string& CNNSegConfig::paddle_proto_file() const {
  // @@protoc_insertion_point(field_get:apollo.perception.lidar.CNNSegConfig.paddle_proto_file)
  return _internal_paddle_proto_file();
}
inline void CNNSegConfig::set_paddle_proto_file(const std::string& value) {
  _internal_set_paddle_proto_file(value);
  // @@protoc_insertion_point(field_set:apollo.perception.lidar.CNNSegConfig.paddle_proto_file)
}
inline std::string* CNNSegConfig::mutable_paddle_proto_file() {
  // @@protoc_insertion_point(field_mutable:apollo.perception.lidar.CNNSegConfig.paddle_proto_file)
  return _internal_mutable_paddle_proto_file();
}
inline const std::string& CNNSegConfig::_internal_paddle_proto_file() const {
  return paddle_proto_file_.GetNoArena();
}
inline void CNNSegConfig::_internal_set_paddle_proto_file(const std::string& value) {
  _has_bits_[0] |= 0x00000020u;
  paddle_proto_file_.SetNoArena(&::apollo::perception::lidar::CNNSegConfig::_i_give_permission_to_break_this_code_default_paddle_proto_file_.get(), value);
}
inline void CNNSegConfig::set_paddle_proto_file(std::string&& value) {
  _has_bits_[0] |= 0x00000020u;
  paddle_proto_file_.SetNoArena(
    &::apollo::perception::lidar::CNNSegConfig::_i_give_permission_to_break_this_code_default_paddle_proto_file_.get(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:apollo.perception.lidar.CNNSegConfig.paddle_proto_file)
}
inline void CNNSegConfig::set_paddle_proto_file(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000020u;
  paddle_proto_file_.SetNoArena(&::apollo::perception::lidar::CNNSegConfig::_i_give_permission_to_break_this_code_default_paddle_proto_file_.get(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:apollo.perception.lidar.CNNSegConfig.paddle_proto_file)
}
inline void CNNSegConfig::set_paddle_proto_file(const char* value, size_t size) {
  _has_bits_[0] |= 0x00000020u;
  paddle_proto_file_.SetNoArena(&::apollo::perception::lidar::CNNSegConfig::_i_give_permission_to_break_this_code_default_paddle_proto_file_.get(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:apollo.perception.lidar.CNNSegConfig.paddle_proto_file)
}
inline std::string* CNNSegConfig::_internal_mutable_paddle_proto_file() {
  _has_bits_[0] |= 0x00000020u;
  return paddle_proto_file_.MutableNoArena(&::apollo::perception::lidar::CNNSegConfig::_i_give_permission_to_break_this_code_default_paddle_proto_file_.get());
}
inline std::string* CNNSegConfig::release_paddle_proto_file() {
  // @@protoc_insertion_point(field_release:apollo.perception.lidar.CNNSegConfig.paddle_proto_file)
  if (!_internal_has_paddle_proto_file()) {
    return nullptr;
  }
  _has_bits_[0] &= ~0x00000020u;
  return paddle_proto_file_.ReleaseNonDefaultNoArena(&::apollo::perception::lidar::CNNSegConfig::_i_give_permission_to_break_this_code_default_paddle_proto_file_.get());
}
inline void CNNSegConfig::set_allocated_paddle_proto_file(std::string* paddle_proto_file) {
  if (paddle_proto_file != nullptr) {
    _has_bits_[0] |= 0x00000020u;
  } else {
    _has_bits_[0] &= ~0x00000020u;
  }
  paddle_proto_file_.SetAllocatedNoArena(&::apollo::perception::lidar::CNNSegConfig::_i_give_permission_to_break_this_code_default_paddle_proto_file_.get(), paddle_proto_file);
  // @@protoc_insertion_point(field_set_allocated:apollo.perception.lidar.CNNSegConfig.paddle_proto_file)
}

// optional string paddle_weight_file = 7 [default = "./data/models/cnnseg/params"];
inline bool CNNSegConfig::_internal_has_paddle_weight_file() const {
  bool value = (_has_bits_[0] & 0x00000040u) != 0;
  return value;
}
inline bool CNNSegConfig::has_paddle_weight_file() const {
  return _internal_has_paddle_weight_file();
}
inline void CNNSegConfig::clear_paddle_weight_file() {
  paddle_weight_file_.ClearToDefaultNoArena(&::apollo::perception::lidar::CNNSegConfig::_i_give_permission_to_break_this_code_default_paddle_weight_file_.get());
  _has_bits_[0] &= ~0x00000040u;
}
inline const std::string& CNNSegConfig::paddle_weight_file() const {
  // @@protoc_insertion_point(field_get:apollo.perception.lidar.CNNSegConfig.paddle_weight_file)
  return _internal_paddle_weight_file();
}
inline void CNNSegConfig::set_paddle_weight_file(const std::string& value) {
  _internal_set_paddle_weight_file(value);
  // @@protoc_insertion_point(field_set:apollo.perception.lidar.CNNSegConfig.paddle_weight_file)
}
inline std::string* CNNSegConfig::mutable_paddle_weight_file() {
  // @@protoc_insertion_point(field_mutable:apollo.perception.lidar.CNNSegConfig.paddle_weight_file)
  return _internal_mutable_paddle_weight_file();
}
inline const std::string& CNNSegConfig::_internal_paddle_weight_file() const {
  return paddle_weight_file_.GetNoArena();
}
inline void CNNSegConfig::_internal_set_paddle_weight_file(const std::string& value) {
  _has_bits_[0] |= 0x00000040u;
  paddle_weight_file_.SetNoArena(&::apollo::perception::lidar::CNNSegConfig::_i_give_permission_to_break_this_code_default_paddle_weight_file_.get(), value);
}
inline void CNNSegConfig::set_paddle_weight_file(std::string&& value) {
  _has_bits_[0] |= 0x00000040u;
  paddle_weight_file_.SetNoArena(
    &::apollo::perception::lidar::CNNSegConfig::_i_give_permission_to_break_this_code_default_paddle_weight_file_.get(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:apollo.perception.lidar.CNNSegConfig.paddle_weight_file)
}
inline void CNNSegConfig::set_paddle_weight_file(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000040u;
  paddle_weight_file_.SetNoArena(&::apollo::perception::lidar::CNNSegConfig::_i_give_permission_to_break_this_code_default_paddle_weight_file_.get(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:apollo.perception.lidar.CNNSegConfig.paddle_weight_file)
}
inline void CNNSegConfig::set_paddle_weight_file(const char* value, size_t size) {
  _has_bits_[0] |= 0x00000040u;
  paddle_weight_file_.SetNoArena(&::apollo::perception::lidar::CNNSegConfig::_i_give_permission_to_break_this_code_default_paddle_weight_file_.get(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:apollo.perception.lidar.CNNSegConfig.paddle_weight_file)
}
inline std::string* CNNSegConfig::_internal_mutable_paddle_weight_file() {
  _has_bits_[0] |= 0x00000040u;
  return paddle_weight_file_.MutableNoArena(&::apollo::perception::lidar::CNNSegConfig::_i_give_permission_to_break_this_code_default_paddle_weight_file_.get());
}
inline std::string* CNNSegConfig::release_paddle_weight_file() {
  // @@protoc_insertion_point(field_release:apollo.perception.lidar.CNNSegConfig.paddle_weight_file)
  if (!_internal_has_paddle_weight_file()) {
    return nullptr;
  }
  _has_bits_[0] &= ~0x00000040u;
  return paddle_weight_file_.ReleaseNonDefaultNoArena(&::apollo::perception::lidar::CNNSegConfig::_i_give_permission_to_break_this_code_default_paddle_weight_file_.get());
}
inline void CNNSegConfig::set_allocated_paddle_weight_file(std::string* paddle_weight_file) {
  if (paddle_weight_file != nullptr) {
    _has_bits_[0] |= 0x00000040u;
  } else {
    _has_bits_[0] &= ~0x00000040u;
  }
  paddle_weight_file_.SetAllocatedNoArena(&::apollo::perception::lidar::CNNSegConfig::_i_give_permission_to_break_this_code_default_paddle_weight_file_.get(), paddle_weight_file);
  // @@protoc_insertion_point(field_set_allocated:apollo.perception.lidar.CNNSegConfig.paddle_weight_file)
}

// optional bool use_paddle = 8 [default = false];
inline bool CNNSegConfig::_internal_has_use_paddle() const {
  bool value = (_has_bits_[0] & 0x00000080u) != 0;
  return value;
}
inline bool CNNSegConfig::has_use_paddle() const {
  return _internal_has_use_paddle();
}
inline void CNNSegConfig::clear_use_paddle() {
  use_paddle_ = false;
  _has_bits_[0] &= ~0x00000080u;
}
inline bool CNNSegConfig::_internal_use_paddle() const {
  return use_paddle_;
}
inline bool CNNSegConfig::use_paddle() const {
  // @@protoc_insertion_point(field_get:apollo.perception.lidar.CNNSegConfig.use_paddle)
  return _internal_use_paddle();
}
inline void CNNSegConfig::_internal_set_use_paddle(bool value) {
  _has_bits_[0] |= 0x00000080u;
  use_paddle_ = value;
}
inline void CNNSegConfig::set_use_paddle(bool value) {
  _internal_set_use_paddle(value);
  // @@protoc_insertion_point(field_set:apollo.perception.lidar.CNNSegConfig.use_paddle)
}
